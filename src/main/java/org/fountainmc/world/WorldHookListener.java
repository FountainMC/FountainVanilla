...
public class WorldHookListener implements IWorldEventListener {
    ...
    public void onEntityAdded(Entity var1) {
        WetServer.getInstance().getPluginManager().fireEvent(new EntitySpawnEvent(var1.getFountainEntity(), var1.getFountainEntity().getLocation()));
    }


    @Override
    public void onEntityRemoved(Entity var1) {
        WetServer.getInstance().getPluginManager().fireEvent(new EntityRemovedEvent(var1.getFountainEntity(), var1.getFountainEntity().getLocation()));
    }
